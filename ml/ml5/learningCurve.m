...
%ThetaTrain = trainLinearReg(X,y,0);



for i = 1:m,
	ThetaTrain = trainLinearReg(X(1:i,:),y(1:i),lambda);
	error_train(i,1) = linearRegCostFunction(X(1:i,:), y(1:i,:),ThetaTrain,0);
end;
...
for i = 1:m,
	ThetaTrain = trainLinearReg(X(1:i,:),y(1:i),lambda);
	error_val(i,1) = linearRegCostFunction(Xval, yval,ThetaTrain,0);
end;
