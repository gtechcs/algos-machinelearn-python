...
public class IntArrayBag implements Cloneable
{
   ...
   **/   
   ...
   /**
    * These methods provide iteration thru the bag.  
    * This class maintains an internal position, 
    * reset sets this position to the first item in the bag,
    * getNextItem returns this data value, and updates the internal position.
    * @note
    * 
    **/   
   public void reset(){
   ...
   *   Indicates that there are no more elements in bag during iteration sequence.
    * @note
    * 	
    **/
   public int getNextItem(){
	   if(iteratingIndex == manyItems){
		   throw new java.util.NoSuchElementException();
	   }
	   
	   return data[iteratingIndex++];
   }
    ...
    * getNextItem returns this data value, and updates the internal position.
   * @return
   *   if there are more elements prsent, while iterating  
    * @note
    * 	
    **/   
