...
public class CharNode
{
   ...
   **/
    ...
    * @param head
    * @return
    * 	the head pointer of the new, shorter linked list.
    * @notes
    * 	No need to check for null head, because precondition guarantees at least one node 
    * 
    */
   public static CharNode listTailRemove(CharNode head){
	   ...
	   preCursor = headNode;
	   cursor = headNode.link;
	   while(cursor.link != null){
		   CharNode next = cursor.link;
		   preCursor = cursor;
		   cursor = next;
	   }
	   preCursor.link = null; 
...
//   			System.out.println("Cursor "+ cursor);
   	 ...
   	 * 
   	 */
   	public static void outList(CharNode headPtr){
	   ...
	   //DO NOT COMMENT
	   System.out.println(sb.toString()); // DO NOT COMMENT
	   //DO NOT COMMENT
   	}
    ...
    * 
    * @precondition
    * 	headptr is the head pointer of a linked list 
    * @postcondition
